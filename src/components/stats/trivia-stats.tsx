      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td align="center">
              7200 kilomètres soit plus de 2 Tours de France complétés
            </td>
          </tr>
          <tr>
            <td align="center">Dénivelé positif</td>
            <td align="center">
              55 000 mètres soit plus de 6 fois l'Ascension de l'Everest
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="center">
              5 mois soit un peu plus que le temps de gestation d'une chèvre
            </td>
          </tr>
          <tr>
            <td align="center">Monnaies utilisées</td>
            <td align="center">
              4 monnaies : euro <strong>(€)</strong>, couronne danoise{" "}
              <strong>(DKK)</strong>, couronne norvégienne{" "}
              <strong>(NOK)</strong>, couronne suédoise <strong>(SEK)</strong>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="center">
              7 visites : 2 à Bergen, 1 à Reed, 1 à Trondheim, 1 à Tromsø, 1 à
              Luleå et 1 à Umeå
            </td>
          </tr>
          <tr>
