...
const TriviaStats: React.FC = () => {
    ...
    return (<>
        <p>Quelques infos et équivalences amusantes.</p>
        <table>
            ...
            <tbody>
                <tr>
                    <td>Kilomètres</td>
                    <td>7200 soit plus de 2 Tours de France complétés</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>156 soit presque 4 aventures Koh Lanta</td>
                </tr>
                <tr>
                    <td>Mois entiers écoulés</td>
                    <td>5 soit un peu plus que le temps de gestation d'une chèvre</td>
                </tr>
                <tr>
                    <td>Monnaies utilisées</td>
                    <td>4 : euro <strong>(€)</strong>, couronne danoise <strong>(DKK)</strong>, couronne norvégienne <strong>(NOK)</strong>, couronne suédoise <strong>(SEK)</strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>7 : 2 fois à Bergen, 1 à Reed, 1 à Trondheim, 1 à Tromsø, 1 à Luleå et 1 à Umeå</td>
                </tr>
                <tr>
                    <td>Crevaisons</td>
                    <td>0</td>
